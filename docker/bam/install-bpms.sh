...
# Modify dashbuilder jboss-web.xml
echo "Modify dashbuilder jboss-web.xml"
...
# Add AngryTweet dashboard
echo "Add AngryTweet dashboard"
cp $CONFIGURATION_DIR/bam/* $SERVER_INSTALL_DIR/$SERVER_NAME/standalone/deployments/dashbuilder.war/WEB-INF/etc/appdata/initialData
cp $ANGRYTWEET_DASHBOARD_JAR $SERVER_INSTALL_DIR/$SERVER_NAME/standalone/deployments/dashbuilder.war/WEB-INF/lib

# Remove Dashboard Showcases
echo "Remove Dashboard Showcases"
rm -f $SERVER_INSTALL_DIR/$SERVER_NAME/standalone/deployments/dashbuilder.war/WEB-INF/lib/$DASHBOARD_LIB_JBPM
rm -f $SERVER_INSTALL_DIR/$SERVER_NAME/standalone/deployments/dashbuilder.war/WEB-INF/lib/$DASHBOARD_LIB_SAMPLE

# Remove Business Central
echo "Remove Business Central"
